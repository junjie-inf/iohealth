...
function d3threeD(exports) {
    ...
    function transformSVGPath(pathStr, width, height) {
		width = width/2;
		height = height/2;
            ...
            switch (activeCmd) {
                ...
                case 'z':
                    ...
                    if (x !== firstX || y !== firstY)
                        path.lineTo(firstX-width, firstY-height);
                ...
                case 'S':
                    ...
                    nx = eatNum();
                    ny = eatNum();
                    path.bezierCurveTo(x1-width, y1-height, x2-width, y2-height, nx-width, ny-height);
                    x = nx; y = ny;
                    break;
                case 'c':
                    x1 = x + eatNum();
                ...
                case 'T':
                    ...
                    nx = eatNum();
                    ny = eatNum();
                    path.quadraticCurveTo(x1-width, y1-height, nx-width, ny-height);
                    x = nx;
                    y = ny;
                    break;
                case 'q':
                ...
                case 'A':
                    ...
                    path.absarc(cx-width, cy-height, rx, startAng, startAng + deltaAng, sf);
                    x = nx;
                    y = ny;
                    break;
