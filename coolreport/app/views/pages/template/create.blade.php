...
@section('title', trans('sections.template.create'))
	...
	<div class="col-lg-12">
		<div class="box">
			<div class="box-header">
				<h2><i class="icon-plus"></i><span class="break"></span>{{ trans('sections.template.create') }}</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				...
				<form class="form-horizontal form-template-store fix-margins" action="" data-type="template">
						...
						<div class="well row">
							<div class="col-sm-6">
								...
								<label class="switch switch-primary">
										      <input id="geolocation" name="geolocation" type="checkbox" checked="" class="switch-input">
							...
							<div class="col-sm-6">
								...
								<button id="template-date-filter-none" type="button" class="btn btn-sm btn-primary template-date-filter" data-toggle="button" title="Mark this field as date filter"><i class="icon-calendar-empty"></i> {{ trans('templates.none') }}</button>
								<button id="template-date-filter-created-at" type="button" class="btn btn-sm btn-primary template-date-filter active" data-toggle="button" title="Mark this field as date filter"><i class="icon-calendar"></i> {{ trans('templates.creation') }}</button>
							</select></div>
