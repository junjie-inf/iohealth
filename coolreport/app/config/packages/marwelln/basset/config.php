    ...
    'aliases' => array(
        ...
        'filters' => array(
            ...
            */
            ...
            {
                // base_path resta los siguientes argumentos a la url original, para añadir las anteriores /coolreport/coolreport en este equipo
                $filter->setArguments(base_path().'/../../')->whenAssetIsStylesheet();
            }),
